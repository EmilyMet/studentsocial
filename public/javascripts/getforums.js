...
xhr.open('GET', 'https://us-central1-studentsocial-nuig.cloudfunctions.net/getforumtype');
    ...
    if (xhr.readyState === DONE) {
        if (xhr.status === OK) {
			...
			if(resultFound == false){
				sHTML += "<div id='noResult' class='textBubble'>  No result found. Check your spelling for mistakes and try again, or create a forum <a href='./createAForum.html'>here</a></div>";
			}
